...
interface MonthProp{
  startChristmasMonth: number;
}

export function MobileHero({startChristmasMonth}: MonthProp) {
  ...
  console.log(startChristmasMonth)
  return (
    <div className="relative h-[20rem] w-full lg:hidden overflow-hidden rounded-b-4xl shadow-md">
      ...
      <div className="relative z-10 flex flex-col justify-end h-full px-6 py-6 text-black space-y-2">
        ...
        <motion.p
            ...
            className={`text-md md:text-lg max-w-md leading-relaxed ${isChristmas ? "!text-white" : "text-muted-foreground"}`}
            >
      ...
      <div className="absolute right-4 bottom-0">
        <div className={`bg-white backdrop-blur-sm h-[15rem] w-[9rem] px-2 pt-2 rounded-t-full flex items-center justify-center shadow-xl overflow-hidden ${isChristmas ? "" : "hidden"}`}>
          <Image
